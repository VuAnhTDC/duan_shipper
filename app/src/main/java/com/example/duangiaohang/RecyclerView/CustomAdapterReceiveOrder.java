...
public class CustomAdapterReceiveOrder extends RecyclerView.Adapter<ManagerOderViewHolder> {
    ArrayList<OrderData> list = new ArrayList<>();
    Context context;
    DatabaseReference databaseReference;
    FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();

    public CustomAdapterReceiveOrder(ArrayList<OrderData> list, Context context) {
        this.list = list;
        ...
        if (orderData != null){
            ...
            holder.card_Item_oder.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(context, DetailReceiveOrderActivity.class);
                    OrderData orderData1 = list.get(finalPosition);
                    intent.putExtra("managerOrderData", orderData1);
    ...
    private void getShopAddress(String idShopOrder, ManagerOderViewHolder holder) {
