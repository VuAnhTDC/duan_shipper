...
//
//public class CustomHomeShipperAdapter extends RecyclerView.Adapter<MHTrangChuShipperViewHolder> {
//    ArrayList<ListItemUserTC> listItemUserTCArrayList;
//    Context context;
//
//    FirebaseDatabase firebaseDatabase =  FirebaseDatabase.getInstance();
//    DatabaseReference databaseReference;
//
//    public CustomHomeShipperAdapter(ArrayList<ListItemUserTC> listItemUserTCArrayList , Context context){
//        this.listItemUserTCArrayList = listItemUserTCArrayList;
//        this.context = context;
//    }
//    @NonNull
//    @Override
//    public MHTrangChuShipperViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
//      return new MHTrangChuShipperViewHolder(LayoutInflater.from(context).inflate(com.example.duangiaohang.R.layout.item_mh_trangchu_shipper,parent,false));
//    }
//
//    @Override
//    public void onBindViewHolder(@NonNull MHTrangChuShipperViewHolder holder, int position) {
//
//       if (listItemUserTCArrayList.size() > 0){
//           OrderData orderData = listItemUserTCArrayList.get(position);
//
